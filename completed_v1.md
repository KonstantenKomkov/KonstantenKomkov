...
- пустые репозитории проверяются как часть ожидаемого набора, но не вызывают Git endpoints и дают нулевой вклад;
...
- CI запускает Ruff formatter/linter, строгий mypy, 96 тестов и `pip check` на Python 3.10 и 3.14;
